...
@section('title', '- Cadastro de Experiência')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-cloud"></i> Nova Experiência</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @endcan
                        <li class="breadcrumb-item active">Nova Experiência</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="col-12 col-md-6 form-group px-0 pr-md-2">
                                        ...
                                        <input type="text" class="form-control" id="name" placeholder="Nome da experiência"
