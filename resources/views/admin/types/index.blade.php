...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-circle"></i> Tipos</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Tipos Cadastrados</h3>
                                @can('Criar Tipos')
                                    <a href="{{ route('admin.types.create') }}" title="Novo Tipo" class="btn btn-success"><i
                                            class="fas fa-fw fa-plus"></i>Novo Tipo</a>
                                @endcan
                            </div>
                        </div>

                        @php
                            $heads = [['label' => 'ID', 'width' => 10], 'Nome', 'Categoria', ['label' => 'Ações', 'no-export' => true, 'width' => 15]];
                            $config = [
                                'ajax' => url('/admin/types'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'name', 'name' => 'name'], ['data' => 'category', 'name' => 'category'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
