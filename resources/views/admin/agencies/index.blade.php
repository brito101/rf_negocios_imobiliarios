...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-building"></i> Agências</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item active">Agências</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Agências Cadastradas</h3>
                                @can('Criar Agências')
                                    <a href="{{ route('admin.agencies.create') }}" title="Nova Agência"
                                        class="btn btn-success"><i class="fas fa-fw fa-plus"></i>Nova Agência</a>
                                @endcan
                            </div>
                        </div>
                        ...
                        @php
                            ...
                            $config = [
                                'order' => [[1, 'asc']],
                                'ajax' => url('/admin/agencies'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'alias_name', 'name' => 'alias_name'], ['data' => 'phone', 'name' => 'phone'], ['data' => 'email', 'name' => 'email'], ['data' => 'address', 'name' => 'address'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
