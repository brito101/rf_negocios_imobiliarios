...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-user-plus"></i> Editar Cliente: {{ $client->name }}</h1>
                </div>
                <div class="col-sm-6">
                                ...
                                <div class="d-flex flex-wrap justify-content-start">
                                    ...
                                    <div class="col-12 col-md-3 form-group px-0 pl-md-2">
                                        ...
                                        <input type="text" class="form-control" id="document_registry"
                                            ...
                                            value="{{ old('document_registry') ?? $client->document_registry }}">
                                    </div>

                                    <div class="col-12 col-md-3 form-group px-0 pr-md-2">
                                        <label for="email">E-mail</label>
                                        <input type="email" class="form-control" id="email"
                                            placeholder="E-mail do cliente" name="email"
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 pr-md-2">
                                        ...
                                        <x-adminlte-select2 name="step_id">
                                            @foreach ($steps as $step)
                                                <option
                                                    {{ old('step_id') == $step->id ? 'selected' : ($step->id == $client->step_id ? 'selected' : '') }}
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 px-md-2">
                                        ...
                                        <input type="date" class="form-control date" id="meeting" placeholder=""
                                            name="meeting" value="{{ old('meeting') ?? $client->meeting }}">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 form-group px-0 pl-md-2">
                                        ...
                                        <x-adminlte-select2 name="agency_id">
                                            @foreach ($agencies as $agency)
                                                <option
                                                    {{ old('agency_id') == $agency->id ? 'selected' : ($agency->id == $client->agency_id ? 'selected' : '') }}
