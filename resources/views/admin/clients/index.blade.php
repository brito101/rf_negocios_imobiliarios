                    ...
                    <div class="card">
                        ...
                        @php
                            $heads = [
                                ...
                                'Corretor',
                                'Data',
                                ['label' => 'Data_PTBR', 'no-export' => true],
                                ['label' => 'Ações', 'no-export' => true, 'width' => 20],
                            ];
                            $config = [
                                'order' => [[1, 'asc']],
                                ...
                                'columns' => [
                                    ...
                                    ['data' => 'created_at_pt', 'name' => 'created_at'],
                                    ['data' => 'created_at_pt', 'name' => 'created_at_pt', 'visible' => false],
                                    [
                                        'data' => 'action',
                                        'name' => 'action',
                                        'orderable' => false,
