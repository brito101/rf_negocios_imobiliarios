...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-home"></i> Propriedades</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Propriedades Cadastradas</h3>
                                @can('Criar Propriedades')
                                    <a href="{{ route('admin.properties.create') }}" title="Nova Propriedade"
                                        class="btn btn-success"><i class="fas fa-fw fa-plus"></i>Nova Propriedade</a>
                                @endcan
                            </div>
                        </div>
