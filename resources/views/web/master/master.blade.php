            ...
            <div class="container">
                <div class="navbar-brand">
                    <a href="{{ route('web.home') }}"
                        ...
                        <h1 class="ms-3 d-none d-lg-block"><span class="d-none">RF</span> Negócios Imobiliários</h1>
                    </a>
                </div>
                ...
                <div class="row d-flex justify-content-around text-muted">
                    ...
                    <div class="col-12 col-md-12 col-lg-3 text-center">
                        {{-- <a href="{{ env('CLIENT_DATA_LINK_FACEBOOK') }}" target="_blank"><i
                                class="fab fa-facebook btn-custom text-opposit" title="Facebook"></i></a> --}}
                        <a href="{{ env('CLIENT_DATA_LINK_INSTAGRAM') }}" target="_blank" class="mx-1"><i
                                class="fab fa-instagram btn-custom text-opposit" title="Instagram"></i></a>
                        {{-- <a href="{{ env('CLIENT_DATA_LINK_YOUTUBE') }}" target="_blank"><i
                                class="fab fa-youtube btn-custom text-opposit" title="Youtube"></i></a> --}}
