...
class StepController extends Controller
{
    ...
    {
        CheckPermission::checkAuth('Listar Etapas');
    ...
    {
        CheckPermission::checkAuth('Criar Etapas');
    ...
    {
        CheckPermission::checkAuth('Editar Etapas');
    ...
    {
        CheckPermission::checkAuth('Excluir Etapas');
